...
const S3_14_IMPLEMENTATION_REQUIREMENTS = [
	"implement each redstone acceptance ID with native producer or consumer semantics",
...
export function validateStage3RedstoneDecisionDocument(decision) {
	...
	if (decision.output?.mode !== REDSTONE_COMPATIBILITY_TARGET.outputMode
