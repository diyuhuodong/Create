...
The first runtime slice is `hand_crank -> shaft/cogwheel -> millstone`. Its blocks intentionally use vanilla dirt as a temporary smoke-test material; Java Create assets are not part of this mechanics checkpoint.
