...
The stage-2 mechanical-bearing prototype accepts only the 11 currently adapted kinetic block types and enforces a 16-block assembly limit at collection, snapshot, restore, and runtime assembly boundaries.
