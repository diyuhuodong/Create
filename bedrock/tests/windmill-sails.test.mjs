...
test("windmills count only sail-tagged blocks and require eight sails", () => {
	assert.equal(windmillSailCount([{ typeId: "createbedrock:shaft" }, { typeId: "createbedrock:white_sail" }, { typeId: "createbedrock:red_sail" }, { typeId: "createbedrock:sail_frame" }]), 3);
